...
} from "@/features/home/types/dashboard";
...
const watchlistCompanyNames: Record<(typeof watchlistTickers)[number], string> = {
  TSLA: "Tesla, Inc.",
  META: "Meta Platforms",
  GOOGL: "Alphabet Inc.",
...
function toWatchlistRows(): HomeWatchlistRow[] {
  ...
  return watchlistTickers.map((ticker) => {
    ...
    const quote = latestQuotes[ticker];
    return {
      ticker,
      companyName: watchlistCompanyNames[ticker],
